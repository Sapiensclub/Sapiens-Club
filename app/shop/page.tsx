 ...
 */
const FALLBACK_PRODUCTS: ShopItem[] = [
  { name: "The Sapiens tee", doodleKey: "tee", stampText: "Not for sale — yet" },
  { name: "The morning mug", doodleKey: "mug", stampText: "Not for sale — yet" },
  { name: "The everyday tote", doodleKey: "tote", stampText: "Not for sale — yet" },
];

const DOODLES: Record<string, React.ComponentType<{ className?: string; title?: string }>> = {
  tee: TeeDoodle,
  mug: MugDoodle,
  tote: ToteBag,
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-20 text-center">
      ...
      <div className="mt-16 grid gap-10 sm:grid-cols-3">
        {products.map(({ name, doodleKey, stampText }, idx) => {
          const Art = DOODLES[doodleKey] ?? ToteBag;
          return (
